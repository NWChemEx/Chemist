...
namespace libchemist {
    ...
    public:
        using basis_type = typename CanonicalMO<element_type, tensor_type>::basis_type; // Basis set type

    private:
        using pimpl_type = detail_::CanonicalMOsPIMPL<basis_type, tensor_type>; // PIMPL type
    ...
    public:
         ...
         */
        CanonicalMO(basis_type bs, tensor_type S, tensor_type mo_energies, tensor_type C,
        ...
        /** @brief Creates a new CanonicalMO instance by deep copying another instance.
         *
         * @param rhs The CanonicalMO to be copied
         */
        CanonicalMO(const CanonicalMO<element_type, tensor_type>& rhs);

        /** @brief Creates a new CanonicalMO instance that takes ownership of another instance's state.
         *
         * @param rhs The CanonicalMO whose state is transferred
         */
        CanonicalMO(CanonicalMO<element_type, tensor_type>&& rhs) noexcept;

        /** @brief Makes the current CanonicalMO instance a deep copy of another instance.
         *
         * @param rhs The CanonicalMO to be copied
         */
        CanonicalMO& operator=(const CanonicalMO<element_type, tensor_type>& rhs);

        /** @brief Makes the current CanonicalMO instance take ownership of another instance's state.
         *
         * @param rhs The CanonicalMO to be copied
         */
        CanonicalMO& operator=(CanonicalMO<element_type, tensor_type>&& rhs) noexcept;
    ...
    bool operator==(const CanonicalMO<E1, T>& space1, const CanonicalMO<E2, T>& space2) {
     ...
     */
    template<typename E1, typename E2, typename T>
    bool operator!=(const CanonicalMO<E1, T>& space1, const CanonicalMO<E2, T>& space2) noexcept {
