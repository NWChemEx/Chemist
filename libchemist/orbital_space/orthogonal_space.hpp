...
extern template class OrthogonalSpace<float, type::tensor_of_tensors<float>>;
extern template class OrthogonalSpace<float, type::tensor_of_tensors<double>>;
extern template class OrthogonalSpace<double, type::tensor_of_tensors<float>>;
extern template class OrthogonalSpace<double, type::tensor_of_tensors<double>>;
