...
// *        the same order in both the sparse map and the tensor. e.g. If you have
// *        a sparse map whose dependent indices are occupied-virtual pairs the
// *        tensor you are applying it to needs to be occupied by virtual. If the
// *        tensor is virtual by occupied you will need to transpose it (or
// *        transpose the dependent indices in the sparse map).
// *
// * @tparam TensorType
// * @param sm
