...
namespace libchemist {
    ...
    public:
         ...
         */
        OrbitalSpace(basis_type bs, tensor_type S, tensor_type C, tensor_type Cdagger, tensor_type D);
         ...
         * @param Cdagger The coefficients going from the MO space to the AO space
         */
        OrbitalSpace(basis_type bs, tensor_type S, tensor_type C, tensor_type Cdagger);
        ...
        /** @brief Creates a new OrbitalSpace instance by deep copying another instance.
         *
         * @param rhs The OrbitalSpace to be copied
         */
        OrbitalSpace(const OrbitalSpace<element_type, tensor_type>& rhs);

        /** @brief Creates a new OrbitalSpace instance that takes ownership of another instance's state.
         *
         * @param rhs The OrbitalSpace whose state is transferred
         */
        OrbitalSpace(OrbitalSpace<element_type, tensor_type>&& rhs) noexcept;

        /** @brief Makes the current OrbitalSpace instance a deep copy of another instance.
         *
         * @param rhs The OrbitalSpace to be copied
         */
        OrbitalSpace& operator=(const OrbitalSpace<element_type, tensor_type>& rhs);

        /** @brief Makes the current OrbitalSpace instance take ownership of another instance's state.
         *
         * @param rhs The OrbitalSpace to be copied
         */
        OrbitalSpace& operator=(OrbitalSpace<element_type, tensor_type>&& rhs) noexcept;
