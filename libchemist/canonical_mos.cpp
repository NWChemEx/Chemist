...
#define CanMO CanonicalMO<e_type, t_type>
    ...
    template<typename e_type, typename t_type>
    CanMO::CanonicalMO(basis_type bs, t_type S, t_type mo_energies, t_type C, t_type Cdagger, t_type D) :
        OrthSpace(std::make_unique<pimpl_type>(bs, S, mo_energies, C, Cdagger, D)) {}

    template<typename e_type, typename t_type>
    CanMO::CanonicalMO(basis_type bs, t_type S, t_type mo_energies, t_type C, t_type Cdagger) :
