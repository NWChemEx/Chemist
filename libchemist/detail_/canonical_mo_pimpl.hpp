...
namespace libchemist::detail_ {
    ...
    public:
        /** @brief Creates a new CanonicalMOsPIMPL instance containing empty members. */
        CanonicalMOsPIMPL() : base_pimpl() {};

        /** @brief Creates a new CanonicalMOsPIMPL instance with the provided values.
         *
         ...
         */
        CanonicalMOsPIMPL(basis_type basis_set, tensor_type S, tensor_type mo_energies, tensor_type C,
        ...
        std::unique_ptr<base_pimpl> clone() const override {
            return std::make_unique<CanonicalMOsPIMPL>(this->basis_set(), this->S(), mo_energies(), this->C(),
