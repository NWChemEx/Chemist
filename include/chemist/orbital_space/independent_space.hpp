...
//  *         more sparse maps.
//  *
//  *  Given a sparse map relation between from one space to another space, we
//  term
//  *  the "from space" the "independent space" and the "to space" is termed the
//  *  "dependent space". This class wraps an independent space and associates
//  with
...
//     /** @brief Creates a new IndependentSpace by associating the provided
//     space
//      *         with a set of sparse maps.
//      *
//      *  This ctor can be used to create a new IndependentSpace instance which
//      *  associates @p base with the sparse maps @p sms. Additional sparse
//      maps
//      *  can be added by calling `add_sparse_map`.
//      *
//      *  @param[in] base The orbital space which is an independent space in
//      one
//      *                  or more sparse map relations.
//      *  @param[in] sms The sparse maps to associate with @p base. Default
//      value
//      *                 is an empty map.
//      *
//      *  @throw None No throw guarantee.
...
//      *         @p dep.
//      *
//      *  This function registers a sparse map `L(i->a)`, where `i` is a member
//      of
//      *  the current space and `a` is a member of the orbital space described
//      by
//      *  @p dep. @p dep is allowed to be `*this`.
//      *
//      *  @tparam DepSpace The type of @p dep. Assumed to derive from
//      `BaseSpace`.
//      *
...
//      *                and @p dep.
//      *
//      *  @throw std::bad_alloc if there is a problem storing the relation.
//      Strong
//      *                        throw guarantee.
//      */
...
//      *         @p dep.
//      *
//      *  This function is used to determine how many stored sparse maps
//      describe
//      *  relationships with the current space as the independent space and @p
//      dep
...
//      *
//      *  @return 0 if there is no registered sparsity relationship between
//      this
...
//      *
//      *  This function determines if the current instance is the same as @p
//      rhs.
...
//      *  dep.
//      *
//      *  @tparam DepSpace The type of the space we are hashing. Assumed to
//      derive
//      *                   from BaseSpace.
//      *
...
//  *  map.
//  *
//  *  @param[in] lhs The dependent space on the left-side of the equality
//  operator
//  *  @param[in] rhs The dependent space on the right-side of the equality
//  *                 operator.
//  *
//  *  @return True if @p lhs and @p rhs have sparse maps that are equal and
//  false
//  *          otherwise.
//  *
//  *  @throw None No throw guarantee.
...
//  *                 operator.
//  *
//  *  @return False if @p lhs and @p rhs have sparse maps that are equal and
//  true
//  *          otherwise.
//  *
//  *  @throw None No throw guarantee.
...
// template<typename BaseType>
// bool IndependentSpace<BaseType>::operator==(const IndependentSpace& rhs)
// const {
