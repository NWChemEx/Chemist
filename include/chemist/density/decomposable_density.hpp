...
//     using typename base_type::const_aos_reference;

//     /// Type of the derived space
//     using space_type = wavefunction::Transformed<aos_type>;

//     /// Type of a read-only reference to the derived space
...
//      */
//     const_space_reference space() const { return m_space_; }
...
//      */
//     const_aos_reference basis_set_() const override {
