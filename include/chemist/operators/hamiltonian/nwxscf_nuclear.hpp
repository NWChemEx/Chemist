 ...
 *
 */
class NWXSCF_Nuclear : public detail_::LinearCombination {
private:
    using base_type = detail_::LinearCombination;

    template<typename T>
    static constexpr bool is_me_v = std::is_same_v<NWXSCF_Nuclear, T>;
...
public:
     ...
     *              other.
     */
    NWXSCF_Nuclear(const NWXSCF_Nuclear& other);
     ...
     *  Complexity: Constant.
     */
    NWXSCF_Nuclear(NWXSCF_Nuclear&& other) noexcept;

    /// Defaulted no-throw dtor
    virtual ~NWXSCF_Nuclear() noexcept;
     ...
     *              other.
     */
    NWXSCF_Nuclear& operator=(const NWXSCF_Nuclear& other);
     ...
     *  Complexity: Constant.
     */
    NWXSCF_Nuclear& operator=(NWXSCF_Nuclear&& other) noexcept;
    ...
    explicit NWXSCF_Nuclear(OpType&& op0, Args&&... args);
