...
class Exchange
  : public detail_::OperatorImpl<Exchange<LHSParticle, RHSParticle>,
                                 LHSParticle, RHSParticle> {
private:
    /// Type of *this
    using my_type = Exchange<LHSParticle, RHSParticle>;
...
public:
    ...
    explicit Exchange(lhs_value_type p0 = lhs_value_type{},
