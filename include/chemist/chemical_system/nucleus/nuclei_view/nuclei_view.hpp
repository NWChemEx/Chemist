...
//  *
//  *  Nuclei objects own their state. The NucleiView class aliases existing
//  state,
...
//     template<typename U>
//     using apply_const_ref = typename traits_type::template
//     apply_const_ref<U>;
...
//      *
//      *  @param[in] pimpl A pointer to the istance's state. If @p pimpl is
//      null
...
//      *
//      *  This ctor will make a new NucleiView which is a deep copy of @p
//      other.
...
//      *  constructor is called the resulting object will behave like a
//      reference
...
//      *
//      *  This ctor will move the state in @p other into a newly created
//      object.
//      *
//      *  @param[in,out] other The object whose state is being transferred to
//      *                       make *this. After this operation @p other will
//      be
...
//      *  overwrites the state of *this with that deep copy. See the copy
//      ctor's
...
//      *
//      *  @throw std::bad_alloc if the copy ctor throws. Strong throw
//      guarantee.
//      */
...
//      *
//      *  This function will release the state contained in *this and transfer
//      it
//      *  to *this.
//      *
...
//      *
//      *  This function will "swap" the state of *this with the state in @p
//      other.
//      *  Thus, after this call *this will contain the state which was
//      previously
//      *  in @p other and @p other will contain the state which previously was
//      in
//      *  *this.
//      *
//      *  @param[in,out] other The view to swap state with. After this call
//      *                       @p other will contain the state which was in
//      *this.
//      *
//      *  @throw None No throw guarantee.
//      */
...
//      *
//      *  The NucleiView class defines different as not value equal. Value
//      equal
//      *  is defined by the corresponding operator==. This method simply
//      negates
...
//  */
// template<typename NucleiType>
// inline bool operator==(const typename NucleiView<NucleiType>::nuclei_type&
// lhs,
...
//  *  simply calls NucleiView::operator!= on @p lhs. See the documentation of
//  the
...
//  *
//  *  @param[in,out] os The stream we are printing to. After the operation @p
//  os
