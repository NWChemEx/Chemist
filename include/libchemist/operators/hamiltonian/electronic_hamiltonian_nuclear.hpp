...
/** @brief Hamiltonian derivatives focused exclusively on interactions involving electrons.
 *
 *  The ElectronicHamiltonian derivatives is at the moment a strong type meant to signify
 *  that the Hamiltonian derivatives shouldn't contain any terms which do not involve
...
public:
    ...
    /** @brief Convenience ctor for creating an ElectronicHamiltonian derivative from the
     *         full system Hamiltonian derivative.
     *
     *  This function will loop over the terms in @p H and pull out those which
     *  depend on one or more electrons. The resulting ElectronicHamiltonian derivative
