...
// /** @brief Determines the non-zero tiles in a TiledArray array given a
// SparseMap
//  *
//  *  This function creates a shape object based off of the provided sparse map
//  *  and tilings. The shape object is used to inform TiledArray which tiles
//  are
...
//  *                      @p idx2mode is an @f$i + d@f$ element vector where
//  the
//  *                      @f$j@f$-th element is the mode of @p tr corresponding
//  to
//  *                      the @f$j@f$-th mode of @p sm (counting assumes
//  *                      concatenation of the independent modes followed by
//  the
//  *                      dependent modes).
//  *
...
//  *  @throw std::runtime_error If any element of @p idx2mode is larger than
//  the
//  *                            rank of @p tr. Strong throw guarantee.
//  */
// TA::SparseShape<double> sparse_map_to_shape(const sparse_map::SparseMapEE&
// sm,
