...
//  *
//  *  @tparam VariantType The type of the std::variant wrapped in this class.
//  The
//  *                      types in the std::variant will be labeled tensor
//  *                      instances, or the types resulting from combining
//  labeled
...
//      *         floating point type.
//      *
//      *  This type trait can be used via SFINAE to selectively disable
//      overloads
...
//      */
//     template<typename T>
//     using disable_if_float_t =
//     std::enable_if_t<!std::is_floating_point_v<T>>;

//     /** @brief Type trait which is used to enable an overload if @p T is a
//      *         floating point type.
//      *
//      *  This type trait can be used via SFINAE to selectively enable
//      overloads
...
//      *
//      *  @param[in] v The variant containg a tensor expression we are
//      wrapping.
//      */
...
//      *
//      *  @tparam RHSType The type of the tensor expression we are adding to
//      the
//      *                  wrapped tensor expression.
//      *
//      *  @param[in] rhs The tensor expression being added to the wrapped
//      tensor
//      *                 expression.
...
//      *
//      *  @param[in] rhs The tensor expression being subtracted from the
//      wrapped
//      *                 tensor expression.
//      *  @return An OpWrapper wrapping the result of subtracting @p rhs from
//      the
//      *          wrapped tensor expression.
//      */
//     template<typename RHSType>
...
//      *  @tparam <anonymous> A type used to disable this overload when @p
//      RHSType
//      *                      is a floating-point type.
//      *
//      *  @param[in] rhs The tensor expression being multiplied with the
//      wrapped
//      *                 tensor expression.
...
//      *
//      *  @tparam RHSType The type of scalar we are multiplying the wrapped
//      tensor
//      *                  expression by.
//      * @tparam <anonymous> An unnamed integer used to enable this overload
//      when
//      *                     @p RHSType is a floating-point type.
//      *
//      *  @param[in] rhs The floating-point value we are scaling this
//      expression
//      *                 by.
//      *  @return An OpWrapper wrapping the result of scaling the wrapped
//      tensor
//      *          expression by @p rhs.
//      */
...
// /** @brief Allows a floating point value to be right-multiplied by an
// OpWrapper.
//  *
//  *  @relates OpWrapper
//  *
...
//  *  @tparam <anonymous> Type used to selectively enable this function only
//  when
