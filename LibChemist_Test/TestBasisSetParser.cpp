...
TEST_CASE("Basis set parsing capabilities") {
    ...
    g94_corr[1].push_back(BasisShell(ShellType::SphericalGaussian, 0, 1,
                                     std::vector<double>({0.1220000}),
                                     std::vector<double>({1.0000000})));
    g94_corr[6].push_back(BasisShell(
      ShellType::SphericalGaussian, 0, 1,
    ...
    g94_corr[6].push_back(BasisShell(ShellType::SphericalGaussian, 2, 1,
                                     std::vector<double>({0.1510000}),
                                     std::vector<double>({1.0000000})));
    g94_corr[6].push_back(BasisShell(
      ShellType::SphericalGaussian, -1, 2, std::vector<double>({0.1687144}),
