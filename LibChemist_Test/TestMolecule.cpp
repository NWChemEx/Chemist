...
std::vector<BasisShell>
a_shell{BasisShell(ShellType::CartesianGaussian, -1, 2,
...
TEST_CASE("Default Molecule") {
    Molecule mol;
    check_state(mol, {},  {});
}

TEST_CASE("Molecule aggregate initialized") {
