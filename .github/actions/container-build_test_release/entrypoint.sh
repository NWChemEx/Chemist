...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_chemist:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_chemist:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_chemist:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_chemist:gcc-latest
fi
