...
//             auto pmoved_defaulted = &(moved_defaulted =
//             std::move(defaulted)); REQUIRE(moved_defaulted ==
//             other_defaulted); REQUIRE(pmoved_defaulted == &moved_defaulted);
...
//         // rely on the public API to test that we actually implemented it
//         right.
