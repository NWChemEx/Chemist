...
TEMPLATE_LIST_TEST_CASE("Coulomb", "", types2test) {
    ...
    using coulomb_type = Coulomb<lhs_type, rhs_type>;

    coulomb_type defaulted;
    coulomb_type value(corr_lhs_value, corr_rhs_value);
