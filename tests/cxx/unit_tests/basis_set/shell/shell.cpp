...
//  * most of the API works (assuming we implemented the hooks correctly). We
//  also
//  * know by using ShellPIMPL that the implementations for the Shell class
//  work.
...
//     vector_t es{4.0, 5.0, 6.0};
//     auto ptr1 =
//     std::make_unique<detail_::ShellPIMPL<double>>(ShellType::pure,
//                                                               2, &cs, &es);
