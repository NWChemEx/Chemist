...
// static void check_state(T&& pimpl, ShellType p, int l, std::size_t size, U&&
// cs,
//                         V&& es) {
...
//         vector_t{}); SECTION("Value") { REQUIRE(p.purity() ==
//         ShellType::cartesian); } SECTION("Is read/write-able") {
...
//     }
//     SECTION("Spherical") {
//         const ShellPIMPL<double> p(ShellType::pure, 0, vector_t{},
//         vector_t{}); SECTION("Value") { REQUIRE(p.purity() ==
//         ShellType::pure); } SECTION("Is read-only") {
//             STATIC_REQUIRE(
//               std::is_same_v<const ShellType&, decltype(p.purity())>);
//         }
//     }
