...
//     std::vector pures{ShellType::pure, ShellType::cartesian,
//     ShellType::pure}; std::vector<std::size_t> ls{0, 2, 4}; std::vector v(6,
//     std::vector<double>{1.0, 2.0, 3.0}); std::vector coefs{v[0], v[2], v[4]};
