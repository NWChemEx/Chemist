...
//  * ContractedGaussianView's API. Most of ContractedGaussianView's
//  implementation
//  * is tested for us by virtue of wrapping a ContractedGaussian instance. We
//  need
//  * to still test:
//  *
//  * - ctors
...
//     ContractedGaussianView<double> v; // Basically just making sure it
//     compiles
// }
...
//         STATIC_REQUIRE(std::is_same_v<PrimitiveView<double>,
//         decltype(g[0])>);
//     }
// }
