...
// /* Testing Strategy:
//  *
//  * Prior testing of the Point<T> and utilities::IndexableContainerBase
//  classes
...
//     auto [prims, g] = make_ctgo();
//     auto prim0      = g[0];
//     SECTION("State") { REQUIRE(static_cast<const prim_t&>(prim0) ==
//     prims[0]); } SECTION("Is read/write-able") {
//         STATIC_REQUIRE(std::is_same_v<double&,
//         decltype(prim0.coefficient())>);
...
//     auto prim0            = g[0];
//     SECTION("State") { REQUIRE(static_cast<const prim_t&>(prim0) ==
//     prims[0]); } SECTION("Is read-only") {
//         using constd = const double&;
//         STATIC_REQUIRE(std::is_same_v<constd,
//         decltype(prim0.coefficient())>);
