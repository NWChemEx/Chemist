...
TEST_CASE("TA Hashers with BPHASH", "[TA],[hash]") {
    ...
    SECTION("TA::Range") {
        ...
        SECTION("Absolute tests") {
            ...
            CHECK(hash_objects(R3) == "c2a4d10163c903bca9bcda0b5d0a110c");
            CHECK(hash_objects(R4) == "3188973e7814661832a815b06b50b22c");
        }
    }
    SECTION("TA::TiledRange1 and TA::TiledRange hash:") {
        ...
        SECTION("Absolute hash tests") {
            ...
            CHECK(hash_objects(tr3) == "c700de70f48345cf37f5bec3fc4078e7");
            CHECK(hash_objects(TR0) == "94d6d17d9a96268c42263124f58c754f");
            CHECK(hash_objects(TR1) == "bf931e548ad5a8192f10724969e80cc9");
            CHECK(hash_objects(TR3) == "1aaa2a5212f8e1c2679132a3543a82a1");
        }
    }
    SECTION("TA::DistArray and TA::Tensor absolute hash tests") {
        ...
        CHECK(hash_objects(A1) == "10111db3db25d77dbebe0d800f0e1f3d");
        CHECK(hash_objects(A3) == "689de315b42e3f4cf3f3beeade1bd049");
        CHECK(hash_objects(A4) == "04686d96da535aea2efff996e2fc8a35");
        CHECK(hash_objects(A5) == "f2a6ab41144279105fffa838e0eeadad");
        ...
        CHECK(hash_objects(T7) == "c6d3311c380bdabf7370f3472f6a04a1");
        CHECK(hash_objects(SA1) == "9457f8abf99dec9c4a63e698acb2f5eb");
        CHECK(hash_objects(SA2) == "7e6acd7acf4a5096d2576be8021371c5");
        CHECK(hash_objects(SA3) == "d60b8ae541c6095aaee8f54ddebb85a7");
    }
}
