...
TEST_CASE("einsum"){
  ...
  TA::TSpArrayD mat(world, matrix_il{vector_il{1.0, 2.0, 3.0},
                                     vector_il{4.0, 5.0, 6.0}});
  TA::TSpArrayD sq_tensor(world, tensor_il{matrix_il{vector_il{1.0, 2.0, 3.0},
                                                     vector_il{4.0, 5.0, 6.0},
                                                     vector_il{7.0, 8.0, 9.0}},
                                           ...
                                           matrix_il{vector_il{19.0, 20.0, 21.0},
                                                     vector_il{22.0, 23.0, 24.0},
                                                     vector_il{25.0, 26.0, 27.0}}});

  TA::TSpArrayD tensor(world, tensor_il{matrix_il{vector_il{1.0, 2.0, 3.0},
                                                  vector_il{4.0, 5.0, 6.0},
                                                  vector_il{7.0, 8.0, 9.0}},
    ...
    SECTION("tensor-tensor"){
      ...
      TA::TSpArrayD corr(world, tensor_il{matrix_il{vector_il{11,26,45,},
                                                    vector_il{68,95,126,},
                                                    vector_il{161,200,243,}},

                                          matrix_il{vector_il{110,143,180,},
                                                    vector_il{221,266,315,},
                                                    vector_il{368,425,486,}},

                                          matrix_il{vector_il{209,260,315,},
                                                    vector_il{374,437,504,},
                                                    vector_il{575,650,729,}}});
