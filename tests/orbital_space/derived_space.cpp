...
//  *   accessible through the DerivedSpace_ members. i.e. as long as that type
//  is
//  *   tested it'll work here too.
//  *
//  * - The base class more-or-less passes through the DerivedSpace_ class.
//  i.e.,
...
//  *
//  *  - We assume that the overlap matrices returned by TensorMaker are
//  suitable
...
//         // Transform is tested elsewhere, here we just make sure it
//         dispatches
//         // correctly
//         if constexpr(tile_is_tot) {
//         } else {
//             tensor_type I(world, {{1.0, 2.0}, {3.0, 4.0}});
//             auto c23 = make_space23<scalar_type>(world);
//             tensor_type corr(world, {{1.8, 2.48}, {2.24, 3.14},
//             {2.79, 4.02}}); REQUIRE(compare_tensors(c23.transform(I, {0}),
//             corr));
//         }
//     }
