...
//     t_type mat_data(world, matrix_il{vector_il{1.0, 2.0},
//     vector_il{3.0, 4.0}}); t_type t3_data(
...
//     SECTION("slice()") {
//         SECTION("Vector") {
//             TWrapper corr(t_type(world, vector_il{1.0, 2.0}));
...
//             TWrapper corr(t_type(world,
//             matrix_il{vector_il{1.0, 2.0, 3.0}})); auto rv =
//             vec.reshape(std::move(p)); REQUIRE(rv == corr);
//         }
...
//         REQUIRE(pluginplay::hash_objects(vec) !=
//         pluginplay::hash_objects(mat));
//     }
...
//     inner_tile mat0(TA::Range({0, 0}, {2, 3}),
...
//         SECTION("Matrix") {
//             REQUIRE(
//               allclose_tot(as_const(mat).template get<t_type>(), mat_data,
//               1));
//         }
//         SECTION("Rank 3 Tensor") {
//             REQUIRE(
