...
class TestHamiltonian(unittest.TestCase):
    def setUp(self):
        ...
        self.coulomb3 = Coulomb(Nuclei(), Nuclei())
        self.defaulted = Hamiltonian()
        self.with_operators = Hamiltonian()
        ...
        self.with_operators.emplace_back(4.0, self.coulomb3.clone())
        self.core = CoreHamiltonian()
        self.core.emplace_back(1.0, self.kinetic.clone())
        self.core.emplace_back(2.0, self.coulomb1.clone())
        self.elec = ElectronicHamiltonian()
        self.elec.emplace_back(1.0, self.kinetic.clone())
        self.elec.emplace_back(2.0, self.coulomb1.clone())
        self.elec.emplace_back(3.0, self.coulomb2.clone())

    def test_size(self):
        self.assertEqual(self.defaulted.size(), 0)
        self.assertEqual(self.with_operators.size(), 4)
    ...
    def test_coefficient(self):
        ...
        self.assertEqual(self.with_operators.coefficient(3), 4.0)
    ...
    def test_get_operator(self):
        ...
        got_coulomb3 = self.with_operators.get_operator(3)
        ...
        self.assertTrue(got_coulomb3.are_equal(self.coulomb3))
    ...
    def test_electronic_hamiltonian(self):
        self.assertEqual(
            self.with_operators.electronic_hamiltonian(), self.elec
        )
    ...
    def test_equality(self):
        ...
        other.emplace_back(4.0, self.coulomb3.clone())
