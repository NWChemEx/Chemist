...
class TestChemicalSystemView(unittest.TestCase):
    ...
    def test_comparisons(self):
        # Default vs. default
        other_default_cs = chemist.ChemicalSystem()
        other_default = chemist.ChemicalSystem(other_default_cs)
    ...
    def setUp(self):
        self.defaulted_cs = chemist.ChemicalSystem()
        self.defaulted = chemist.ChemicalSystemView(self.defaulted_cs)
        self.default_mol = chemist.Molecule()
        self.mol = chemist.Molecule()
        self.mol.push_back(chemist.Atom())
        self.has_dmol_cs = chemist.ChemicalSystem(self.default_mol)
        self.has_default_mol = chemist.ChemicalSystemView(self.has_dmol_cs)
        self.has_mol_cs = chemist.ChemicalSystem(self.mol)
        self.has_mol = chemist.ChemicalSystemView(self.has_mol_cs)
